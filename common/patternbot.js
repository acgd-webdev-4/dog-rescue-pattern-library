 ...
 * @version 1522064790068
 */
const patternManifest_1522064790068 = {
  "commonInfo": {
    "modulifier": [
      "responsive",
      "images",
    ...
    "modulifierUrl": "responsive;images;list-group;embed;media-object;forms;accessibility;print",
    "gridifier": [
      {
        "prefix": "xs",
        "columns": 4,
    ...
    "theme": {
      ...
      "fonts": {
        ...
        "secondary": {
          "name": "--font-secondary",
          "namePretty": "Playfair Display",
          "raw": "\"Playfair Display\", serif",
          "weights": {
            "normal": {
              "weight": "normal",
              "hasNormal": true,
      ...
      "coloursRaw": {
        "--color-primary": "#00d4c4",
        "--color-primary-light": "#b9eee3",
        "--color-secondary": "#ff6871",
        "--color-accent": "#00d4c4",
        "--color-neutral-beige": "#fffff0",
        "--color-whatever": "#bcf5a9"
      },
      "fontsRaw": {
    ...
    "readme": {
      ...
      "bodyBasic": "Garden Life is a small business looking to make your gardening experience a better one. Garden life sells garden supplies and plants to help get peoples gardens started."
    },
    "icons": [
      "artboard-1",
      "artboard-9",
  ...
  "patternLibFiles": {
    ...
    "pages": [
      ...
      },
      {
        "name": "index.html",
        "namePretty": "Home",
        "path": "/Users/paolinamissio/Desktop/AC Graphic Design/Year 2/Web Development/ecommerce-pattern-library/pages/index.html"
      }
    ]
  },
  "userPatterns": [
...
patternBotIncludes(patternManifest_1522064790068);
}());